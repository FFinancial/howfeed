...
.Tweet-text+.Tweet-alert,.Tweet-text+.Tweet-metadata {
	margin-top: 3.2px
}
...
.Tweet--compact .Tweet-author,.Tweet--compact .TweetAuthor {
	margin-top: 0
}
...
.Tweet--compact .Tweet-inReplyTo,.Tweet--compact .Tweet-metadata,.Tweet--compact .TweetAuthor-screenName {
	font-size: 13px
}
...
.SandboxRoot.env-bp-min .Tweet-alert,.SandboxRoot.env-bp-min .Tweet-authorScreenName,.SandboxRoot.env-bp-min .Tweet-card,.SandboxRoot.env-bp-min .Tweet-inReplyTo,.SandboxRoot.env-bp-min .Tweet-metadata {
	font-size: 12.25px
}

.SandboxRoot.env-bp-min .Tweet-text+.Tweet-alert,.SandboxRoot.env-bp-min .Tweet-text+.Tweet-metadata {
	margin-top: 2.8px
}
...
.Tweet-action--heart,.Tweet-action--profile,.Tweet-action--reply {
	display: -webkit-box;
	display: -webkit-flex;
	display: -moz-box;
	display: -ms-flexbox;
...
.TweetAction--reply:active,.TweetAction--reply:focus,.TweetAction--reply:hover {
	color: #1DA1F2;
	text-decoration: none
}

.TweetAction--reply:active .TweetAction-icon,.TweetAction--reply:focus .TweetAction-icon,.TweetAction--reply:hover .TweetAction-icon {
...
.TweetAction--retweet:active,.TweetAction--retweet:focus,.TweetAction--retweet:hover {
	color: #17BF63;
	text-decoration: none
}

.TweetAction--retweet:active .TweetAction-icon,.TweetAction--retweet:focus .TweetAction-icon,.TweetAction--retweet:hover .TweetAction-icon {
...
.TweetAction--heart:active,.TweetAction--heart:focus,.TweetAction--heart:hover {
	color: #E0245E;
	text-decoration: none
}

.TweetAction--heart:active .TweetAction-icon,.TweetAction--heart:focus .TweetAction-icon,.TweetAction--heart:hover .TweetAction-icon {
	background-image: url(data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%3E%3Cpath%20class%3D%22icon%22%20fill%3D%22%23E0245E%22%20d%3D%22M12%2021.638h-.014C9.403%2021.59%201.95%2014.856%201.95%208.478c0-3.064%202.525-5.754%205.403-5.754%202.29%200%203.83%201.58%204.646%202.73.813-1.148%202.353-2.73%204.644-2.73%202.88%200%205.404%202.69%205.404%205.755%200%206.375-7.454%2013.11-10.037%2013.156H12zM7.354%204.225c-2.08%200-3.903%201.988-3.903%204.255%200%205.74%207.035%2011.596%208.55%2011.658%201.52-.062%208.55-5.917%208.55-11.658%200-2.267-1.822-4.255-3.902-4.255-2.528%200-3.94%202.936-3.952%202.965-.23.562-1.156.562-1.387%200-.015-.03-1.426-2.965-3.955-2.965z%22%2F%3E%3C%2Fsvg%3E)
}

.TweetAction--profile:active,.TweetAction--profile:focus,.TweetAction--profile:hover {
	color: #1DA1F2;
	text-decoration: none
}

.TweetAction--profile:active .TweetAction-icon,.TweetAction--profile:focus .TweetAction-icon,.TweetAction--profile:hover .TweetAction-icon {
	background-image: url(data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2024%2024%22%3E%3Cpath%20class%3D%22icon%22%20fill%3D%22%233b94d9%22%20d%3D%22M12%2011.816c1.355%200%202.872-.15%203.84-1.256.814-.93%201.078-2.368.806-4.392-.38-2.825-2.117-4.512-4.646-4.512S7.734%203.343%207.354%206.17c-.272%202.022-.008%203.46.806%204.39.968%201.107%202.485%201.256%203.84%201.256zM8.84%206.368c.162-1.2.787-3.212%203.16-3.212s2.998%202.013%203.16%203.212c.207%201.55.057%202.627-.45%203.205-.455.52-1.266.743-2.71.743s-2.255-.223-2.71-.743c-.507-.578-.657-1.656-.45-3.205zm11.44%2012.868c-.877-3.526-4.282-5.99-8.28-5.99s-7.403%202.464-8.28%205.99c-.172.692-.028%201.4.395%201.94.408.52%201.04.82%201.733.82h12.304c.693%200%201.325-.3%201.733-.82.424-.54.567-1.247.394-1.94zm-1.576%201.016c-.126.16-.316.246-.552.246H5.848c-.235%200-.426-.085-.552-.246-.137-.174-.18-.412-.12-.654.71-2.855%203.517-4.85%206.824-4.85s6.114%201.994%206.824%204.85c.06.242.017.48-.12.654z%22%2F%3E%3C%2Fsvg%3E)
}
...
.TweetAuthor-highlightedLabel a {
	-webkit-text-decoration-color: #697882;
	-moz-text-decoration-color: #697882;
	text-decoration-color: #697882
}
...
.QuoteTweet:active,.QuoteTweet:hover {
	border-color: #ccd6dd
}

.QuoteTweet-link,.QuoteTweet-link:active,.QuoteTweet-link:focus,.QuoteTweet-link:hover,.QuoteTweet-link:visited {
	text-decoration: none;
	color: #1c2022
}
...
.TweetInfo-heart:active,.TweetInfo-heart:focus,.TweetInfo-heart:hover {
	color: #E0245E;
	text-decoration: none
}

.TweetInfo-heart:active .Icon--heart,.TweetInfo-heart:focus .Icon--heart,.TweetInfo-heart:hover .Icon--heart {
	background-image: url(data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%3E%3Cpath%20class%3D%22icon%22%20fill%3D%22%23E0245E%22%20d%3D%22M12%2021.638h-.014C9.403%2021.59%201.95%2014.856%201.95%208.478c0-3.064%202.525-5.754%205.403-5.754%202.29%200%203.83%201.58%204.646%202.73.813-1.148%202.353-2.73%204.644-2.73%202.88%200%205.404%202.69%205.404%205.755%200%206.375-7.454%2013.11-10.037%2013.156H12zM7.354%204.225c-2.08%200-3.903%201.988-3.903%204.255%200%205.74%207.035%2011.596%208.55%2011.658%201.52-.062%208.55-5.917%208.55-11.658%200-2.267-1.822-4.255-3.902-4.255-2.528%200-3.94%202.936-3.952%202.965-.23.562-1.156.562-1.387%200-.015-.03-1.426-2.965-3.955-2.965z%22%2F%3E%3C%2Fsvg%3E)
}
...
.TweetInfo-heartStat:active,.TweetInfo-heartStat:focus,.TweetInfo-heartStat:hover {
	color: #E0245E
}
